...
curl -#fL -o cpptools-linux.vsix -C - https://github.com/microsoft/vscode-cpptools/releases/download/1.4.1/cpptools-linux.vsix
...
chmod +x extensions/ms-vscode.cpptools-1.4.1/debugAdapters/OpenDebugAD7
chmod +x extensions/ms-vscode.cpptools-1.4.1/bin/cpptools
chmod +x extensions/ms-vscode.cpptools-1.4.1/bin/cpptools-srv
...
sed -i -z "s|activationEvents\": \[\s\+\"\*\"|activationEvents\": \[$content|" extensions/ms-vscode.cpptools-1.4.1/package.json
